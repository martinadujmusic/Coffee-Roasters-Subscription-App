...
const OrderForm = forwardRef(
  ({ orderOption, onChange, disabled, settings }, ref) => {
    ...
    return (
      ...
      >
        <button
          className="text-gray-blue font-serif font-black text-[1.5rem] leading-7 text-left flex justify-between items-center md:text-[2rem] md:leading-[2.5rem] xl:text-[2.5rem]"
